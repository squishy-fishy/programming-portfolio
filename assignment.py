...
def main_counted_loops():
	...
	print "testing total_non7s(1, 10): ", total_non7s(1, 10)
...
def main_strings():
	...
	print "testing second_letter('bob'): ", second_letter('bob')
	print "testing one_letter('no games', 6): ", one_letter("no games", 6)
	print "testing concatenate('blue', 'black'): ", concatenate('blue', 'black')
	print "testing beauty('thats a'): ", beauty('thats a')
	print "testing slice_of_life('elephant'): ", slice_of_life('elephant')
	print "slice_of_heaven('abcdefgh', 2): ", slice_of_heaven('abcdefgh', 2)
